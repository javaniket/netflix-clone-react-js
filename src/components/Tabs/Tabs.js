    ...
    return <>
     < section className="tabs">
        <div className="container">
            {renderTabTitle(CANCEL_AT_ANY_TIME, activeTabName===CANCEL_AT_ANY_TIME,
...
{renderTabTitle(PICK_YOUR_PRICE, 
    activeTabName===PICK_YOUR_PRICE,
     "fas fa-tags fa-3x", "tab-2" )}
</div>
</section>
{activeTabName===CANCEL_AT_ANY_TIME && (
    <section className="tab-content">
        <div className="container">
           <div id="tab-1-content" className={'tab-1-content-item $ {activeTabName === CANCEL_AT_ANY_TIME && "show"}'}>
    ...
    <section className="tab-content">
        <div className="container">
            <div id='tab-2-content' className={'tab-content-item $ {activeTabName===WATCH_ANYWHERE && "show"}'}>
                ...
                <div>
                    <img src="https://i.ibb.co/gDhnwWn/tab-content-2-.png" alt="" />
...
{activeTabName === PICK_YOUR_PRICE && (
    <section className="tab-content">
        <div className="container">
           <div id='tab-3-container' className={'tab-content-item $ {activeTabName === PICK_YOUR_PRICE && "show"}'}>
            ...
            <table className='table'>
                ...
                <tbody>
                    <tr>
                        <td>Monthly price after free month ends on 4/19/2023</td>
                        <td>$6.99</td>
                        <td>$11.99</td>
                        <td>$18.99</td>
                    </tr>
                    ...
                    <tr><td>Unlimited movies and TV shows</td>
                    <td>
                            <i className='fas fa-check'></i>
                        </td>
                        <td>
